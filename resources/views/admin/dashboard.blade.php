...
<div class="container-fluid">
    ...
    <br>
    <div class="row">
        <div class="col-sm-12 col-md-6 hide" id="box-popular-post">
        ...
        <div class="col-sm-12 col-md-6 hide" id="box-recent-comment">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Recent Comment
...
$(function(){
    ...
    var html = '<div id="pwd-date-range" class="pull-right" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; margin-top: -40px; margin-right: 45px;">'+
    ...
    function cb(start, end, label) {
        ...
        var range = label;
        @endif
        $('#pwd-date-range span').text(range);
    ...
    function pageview_chart(data) {
        var opt = {
            ...
            legend: {
                {!! !Session::get('is_desktop')?'layout: \'vertical\',':'' !!}
                align: 'right',
                verticalAlign: 'top',
                floating: true,
                borderWidth: 0
    ...
    $('#pwd-date-range').daterangepicker({
        startDate: start,
        endDate: end,
        minDate: min,
        maxDate: max,
