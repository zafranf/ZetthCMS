            ...
            <div class="row">
                <div class="col-sm-12 col-md-12" style="max-height: 500px;overflow: auto;" id="photo-box">
                    <div class="col-sm-6 col-md-2 col-xs-3 no-padding" style="margin-bottom:1px;cursor:pointer;" onclick="addPhotoModal()">
                        <div class="thumbnail text-warning" style="height:{{ Session::get('is_desktop')?'150px':'64px' }};display:table-cell;vertical-align:middle;text-align:center;width:inherit">
                            <i class="fa fa-plus" style="font-size: {{ Session::get('is_desktop')?'80px':'25px' }};"></i>
                            <br>
                            <span class="" style="font-size: {{ Session::get('is_desktop')?'32px':'11px' }};">Add Photo</span>
                        </div>
                    </div>
                    @php $no_img=0 @endphp
                    @if (isset($albums->photos))
                        ...
                        <div id="img{{ ++$no_img }}" class="col-sm-6 col-md-2 col-xs-3 no-padding" style="margin-bottom:1px;">
                            <div class="thumbnail" style="height:{{ Session::get('is_desktop')?'150px':'64px' }};display:table-cell;vertical-align:middle;width:inherit;position:relative;">
...
function addPhoto() {
    ...
    if (img_val!="" && typeof img!="undefined"){
        ...
        var photo = '<div id="img'+no_img+'" class="col-sm-6 col-md-2 col-xs-3 no-padding" style="margin-bottom:1px;">'+
                        '<div class="thumbnail" style="height:{{ Session::get('is_desktop')?'150px':'inherit' }};display:table-cell;vertical-align:middle;width:inherit">'+
