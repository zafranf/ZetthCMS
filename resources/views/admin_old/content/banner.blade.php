...
@section('menu-sort')
  @if (\Auth::user()->can('update-menus'))
    <a href="{{ url('/content/banners/sort') }}" class="btn btn-info" data-toggle="tooltip" data-original-title="Urutkan"><i class="fa fa-sort"></i></a>
  @endif
@endsection
...
<script>
  $(document).ready(function() {
    var table = $('#list').DataTable({
      "processing": true,
      "serverSide": true,
      "ajax": SITE_URL + "/content/banners/data",
      "columns": [
          { "data": "no", "width": "30px" },
      ...
      "columnDefs": [{
        ...
        "render": function (data, type, row, meta) {
          var actions = '';
          var url = SITE_URL + '/content/banners/' + data;
          var del = "_delete('" + url + "')";
          {!! _get_access_buttons() !!}
