<div style="background:#fff;width:90%;margin:0 auto;border:1px solid #ccc;color:#8B8B8B;padding:5px 10px;" id="zetth-email">
  ...
  <hr>
  <p>Halo,</p>
  <p>Kami ingin menginformasikan bahwa saat ini website <b><a href="{{ getSiteURL('/') }}" style="text-decoration:none;color:#7F7D7D">{{ app('site')->name }}</a></b> sudah aktif. Silakan kunjungi website kami. Terima kasih sudah bersedia menunggu.</p>
  <p>
