...
<head>
  ...
  <link rel="shortcut icon"
    href="{{ _get_image("assets/images/" . app('site')->icon, url("themes/admin/AdminSC/images/" . (app('site')->icon ?? 'logo.v2.png'))) }}"
    type="image/x-icon">
  {{-- Styles --}}
    ...
    <div class="container">
      ...
      <div data-wow-delay=".5s" class="nav navbar-nav navbar-right social-icons wow fadeInRight animated animated">
        <ul>
          ...
          <li>
            <a href="{{ $socmed->socmed->url . '/'. $socmed->username }}" target="_blank"
              title="{{ $socmed->socmed->name. ': ' . $socmed->username }}">
